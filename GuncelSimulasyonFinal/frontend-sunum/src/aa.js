 ...
 setoptionMenu(true);
    ...
    return (
        ...
        <div className="App">
            ...
            <MapContainer className="map" center={[state.centerTheMap.lat,state.centerTheMap.lng]} zoom='10' zoomControl={false} attributionControl={false}  >
                    ...
                    markers.map(item =>
                        <Marker key={item.id}  eventHandlers={{
                            ...
                            <Tooltip style={{all: 'revert',
                                ...
                                interactive: 'false',
                                display: 'none',
                                fill: 'false'} } direction="right" offset={[0, 0]} opacity={1} permanent>{item.id}</Tooltip>
                ...
                { isReplay ?
                    replayMarkers.map(item =>
                        <Marker key={item.id}  eventHandlers={{
                            ...
                            <Tooltip direction="right" offset={[0, 0]} opacity={0}  permanent>{item.id}</Tooltip>
                        </Marker>) : null
                }
            ...
            <div id="myModal2" className="modal"  style={{display:'inline-block',width:'300px',left: '84.5%',top: '0%',height:'%100'}}>
                <div className="modal-content" style={{backgroundColor: '#091B32',display:'inline-block',width:'300px',left: '0%',top: '0%',height:'100%'}}>
                    ...
                    <p style={{color:'white'}}>Trace Info </p>
                    ...
                    <p style={{color:'white',display:'inline-block',position: 'fixed',left: '84.5%',top: '35%',height:'%20',width:'300px'}}>Trace Detail </p>
                    ...
                    <p style={{color:'white',position: 'fixed',left: '89.5%',top: '70%'}}>Connection List </p>
